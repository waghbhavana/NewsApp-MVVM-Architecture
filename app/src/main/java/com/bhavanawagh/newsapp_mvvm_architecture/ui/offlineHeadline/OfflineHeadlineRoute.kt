...
fun OfflineHeadlineRoute(onNewsClick: (url: String) -> Unit) {
    ...
    val uiState by offlineHeadlineViewModel.uiState.collectAsStateWithLifecycle()
    offlineHeadlineScreen(uiState, onNewsClick)
}

@Composable
fun offlineHeadlineScreen(uiState: UiState<List<Article>>, onNewsClick: (url: String) -> Unit) {
